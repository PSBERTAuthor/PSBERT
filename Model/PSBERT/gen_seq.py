...
flags.DEFINE_bool("deanon", False, "whether to include ENS dataset.")
...
def main():
    ...
    if FLAGS.tornado:
        tornado_in = open("../../Data/tornado_trans_in_removed.csv", "r")
        tornado_out = open("../../Data/tornado_trans_out_removed.csv", "r")
