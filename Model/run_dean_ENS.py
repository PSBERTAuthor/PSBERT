...
def load_embedding():
    ...
    if FLAGS.algo == "PSBERT":
        embeddings = np.load("PSBERT/data/bert_embedding_" + FLAGS.model_index + ".npy")
        address_for_embedding = np.load("PSBERT/data/address_for_embed_" + FLAGS.model_index + ".npy")
    elif FLAGS.algo == "PSBERT_finetune":
        embeddings = np.load("PSBERT_finetune/data/bert_embedding_" + FLAGS.model_index + ".npy")
        address_for_embedding = np.load("PSBERT_finetune/data/address_for_embed_" + FLAGS.model_index + ".npy")
